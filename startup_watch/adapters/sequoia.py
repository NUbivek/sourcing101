...
class SequoiaAdapter(BaseAdapter):
    """Sequoia portfolio adapter.

    Source: Sequoia companies page.
    Method: HTML parsing.
    Stage signal: seed to growth portfolio.
    Thesis alignment: supply chain/manufacturing signals.
    """
