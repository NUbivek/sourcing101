...
class EntrepreneurshiplifeAdapter(BaseAdapter):
    """Entrepreneurship Life RSS adapter."""

    source_name = "entrepreneurshiplife"
            ...
            for entry in feed.entries[:50]:
                ...
                out.append(
                    StartupSignal(
                        ...
                        stage="seed",
                        categories=["industrial software", "manufacturing"],
