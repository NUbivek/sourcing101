...
class EnterpriseIrelandAdapter(BaseAdapter):
    """Enterprise Ireland client companies adapter."""

    source_name = "enterprise_ireland"
            ...
            for node in soup.select("a, h2, h3"):
                ...
                output.append(
                    StartupSignal(
                        company_name=name,
                        stage="series-a",
                        categories=["manufacturing software", "agtech"],
