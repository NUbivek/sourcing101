...
class BessemerAdapter(BaseAdapter):
    """Bessemer portfolio adapter.

    Source: Bessemer portfolio pages.
    Method: HTML parsing.
    Stage signal: venture-backed later seed/series.
    Thesis alignment: industrial and manufacturing software.
    """
